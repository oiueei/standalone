...
USERS = [
    ...
    },
    {
        ...
        "about": "## Lele's kitchen 🧁\n\nI bake **healthy, natural** cakes for mindful celebrations — vegan, gluten-free or low-sugar, your call. Sharing sweetness is my love language. *Here! Now!! Sharing!!!*",
    },
    {
        "code": "l1l13S",
        "headline": "Hurrah for the Borrow Shelf! Lili's got your gear!",
        "about": "## Borrow, don't buy 🔧\n\nKeeper of the **tool library** and a tinkerer at heart. If it drills, steams, climbs or beeps, I've probably got one to lend. Also swapping *Arduino* bits — resistance is futile!",
    },
    {
        "code": "l0l0oh",
...
COLLECTIONS = [
    ...
    },
    {
        ...
        "description": "Lili's coliving runs on jumper wires and half-finished Arduino dreams. Got a spare Nano gathering dust? A sensor that wasn't quite the one? Pop it on the board, eye up what you fancy, propose a swap. Components only — no cash, no shame, no short circuits.",
    },
    {
        "code": "1u1uC1",
