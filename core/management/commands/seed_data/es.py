...
THINGS = [
    ...
    {"code": "lltl01", "type": "LEND_THING", "owner_code": "l1l13S", "collections": ["l1l1C1"],
     ...
     "condition": "NEW",
     "documents": [{"public_id": "lltl01", "filename": "Kit de taladro robusto.pdf", "content_type": "application/pdf"}]},
    {"code": "lltl02", "type": "LEND_THING", "owner_code": "l1l13S", "collections": ["l1l1C1"],
     ...
     "condition": "GOOD",
     "documents": [{"public_id": "lltl02", "filename": "Limpiador de vapor mágico.pdf", "content_type": "application/pdf"}]},
    {"code": "lltl03", "type": "LEND_THING", "owner_code": "l1l13S", "collections": ["l1l1C1"],
     ...
     "condition": "NEW",
     "documents": [{"public_id": "lltl03", "filename": "Escalera sólida.pdf", "content_type": "application/pdf"}]},
    {"code": "lltl04", "type": "LEND_THING", "owner_code": "l1l13S", "collections": ["l1l1C1"],
     ...
     "condition": "USED",
     "documents": [{"public_id": "lltl04", "filename": "Mega kit de magdalenas.pdf", "content_type": "application/pdf"}]},
    {"code": "lltl05", "type": "LEND_THING", "owner_code": "l1l13S", "collections": ["l1l1C1"],
     ...
     "condition": "FAIR",
     "documents": [{"public_id": "lltl05", "filename": "Báscula de equipaje pro.pdf", "content_type": "application/pdf"}]},
...
FAQS = [
    {"thing_code": "stffa1", "questioner_code": "L3L3oo", "question": "¿Puedo recogerlo a fin de mes?", "answer": "¡Claro que sí, majo!"},
    {"thing_code": "stffa2", "questioner_code": "L3L3oo", "question": "¿Puedo recogerlo a fin de mes?", "answer": "¡Claro que sí, majo!"},
    {"thing_code": "stffa3", "questioner_code": "L3L3oo", "question": "¿Puedo recogerlo a fin de mes?", "answer": "¡Claro que sí, majo!"},
    {"thing_code": "stffa4", "questioner_code": "L3L3oo", "question": "¿Puedo recogerlo a fin de mes?", "answer": "¡Claro que sí, majo!"},
    {"thing_code": "stffa5", "questioner_code": "L3L3oo", "question": "¿Puedo recogerlo a fin de mes?", "answer": "¡Claro que sí, majo!"},
    {"thing_code": "cksle1", "questioner_code": "La1aN1", "question": "¿Cuánto dura en la nevera?", "answer": "2-3 días"},
    {"thing_code": "cksle2", "questioner_code": "La1aN1", "question": "¿Cuánto dura en la nevera?", "answer": "2-3 días"},
    {"thing_code": "cksle3", "questioner_code": "La1aN1", "question": "¿Cuánto dura en la nevera?", "answer": "2-3 días"},
    {"thing_code": "cksle4", "questioner_code": "La1aN1", "question": "¿Cuánto dura en la nevera?", "answer": "2-3 días"},
    {"thing_code": "cksle5", "questioner_code": "La1aN1", "question": "¿Cuánto dura en la nevera?", "answer": "2-3 días"},
]
