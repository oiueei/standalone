...
| `EMAIL_LANGUAGE` | No | Language for ALL outbound email (default: `en`; `es` available). Per-deployment, not per-user — catalogues live in `core/services/email_texts/`; unknown codes fall back to English |
