...
export const TYPE_VALUES = [
  'GIFT_THING', 'SELL_THING', 'ORDER_THING', 'RENT_THING', 'LEND_THING', 'SHARE_THING', 'EVENT_THING', 'WISH_THING', 'ASSET_THING', 'SWAP_THING',
];
...
export const DATE_TYPES = ['LEND_THING', 'RENT_THING', 'SHARE_THING', 'ASSET_THING'];
